...
What is it?
This project proposal is to create an app to allow students to study in real life together with others, and also to create stronger friendships to 
...
To clone a GitHub repository in Visual Studio Code: Clone within Visual Studio Code

Then use the editor to make changes.

To add, commit, and push the changes you have made back to GitHub: Add, commit, and push within Visual Studio Code
